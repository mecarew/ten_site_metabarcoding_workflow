...
slurm_conffile <- here::here("src_mozzie/.batchtools.conf.R")
slurm_template <- here::here("src_mozzie/batchtools.slurm.tmpl")
...
```{r}
# Save the plots
ggsave(file.path(statistics_dir, paste0("forward_", amplicon_group, "_quality.png")),
       plot = g_forward, width = 8, height = 6, dpi = 300)

ggsave(file.path(statistics_dir, paste0("reverse_", amplicon_group, "_quality.png")),
       plot = g_reverse, width = 8, height = 6, dpi = 300)
```
