...
metab_fil <- read.csv("~/git/ten_site_metabarcoding/results/ten_site_data_summaries/ten_sites_vsearch_data_summary_filled_long_format_10_11_2025.csv")

# input  finL flitered metabarcoding data     
metab_filt <- read.csv("~/git/ten_site_metabarcoding/results/ten_site_data_summaries/ten_sites_long_format_10_11_2025.csv")
```
