...
metab_filt <- read.csv(here::here("results/ten_site_data_summaries/ten_sites_final_long_format_16_12_2025.csv")) %>%
  mutate(
    site = case_when(
...
no_bc <- no_bc %>%
  mutate(group = case_when(
    ...
    # Algae / Plants
    phylum %in% c("Rhodophyta", "Ochrophyta", "Bacillariophyta", "Chlorophyta", "Streptophyta", "Cryptista",
    "Gyrista", "Magnoliophyta") | class %in% c("Phaeophyceae", "Synurophyceae") ~ "algae/plants",
