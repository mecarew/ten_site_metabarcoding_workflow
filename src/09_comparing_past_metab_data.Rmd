...
metab_filt <- read.csv(paste0(dir,"results/ten_site_data_summaries/ten_sites_final_long_format_04_12_2025.csv")) %>%
  mutate(year = 2021)
...
nmds_plot <- ggplot(scores_df, aes(NMDS1, NMDS2, color = treatment, shape = site)) +
  ...
  theme(
    ...
    axis.title.x = element_text(hjust = 0), # left-align x-axis label
    axis.title.y = element_text(hjust = 0), # left-align y-axis label
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)
  )
#-------------------------------------------------------------
# Save as PNG
ggsave(
  filename = "past_data/ten_sites_past_nmds_plot.png",  # file name
...
ggsave(
  filename = "past_data/ten_sites_past_nmds_plot.png",
  plot = nmds_plot,
  width = 8,
  height = 6
)
