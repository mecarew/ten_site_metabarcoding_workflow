...
1.    Clone a copy of the workflow from the PEARG github repository onto your server directory (for this I have set up a directory called 'git' for cloned repositories). You'll need a github account to do this (see - https://docs.github.com/en/get-started/onboarding/getting-started-with-your-github-account).
...
Git can be added to the top rigth pane of your rstudio window using the instructions below:
